...
Here is the tech stack I work with daily:

*   **Languages:** C++, Python, JavaScript, TypeScript, HTML/CSS, Shell Scripting
*   **AI & Data Science:** Scikit-Learn, Random Forest Classifiers, Joblib, Pandas, NumPy
*   **Web & Systems:** Node.js, React, Next.js, Express, MetaTrader 5 API, Windows API, Linux Systems
*   **Developer Tools:** Git, VS Code, CLI/TUI Libraries

---

### 📫 How to Reach Me

If you'd like to collaborate on a project, discuss systems programming or quantitative finance, or just say hello:

*   **Email:** [uofuzor72@gmail.com](mailto:uofuzor72@gmail.com)
*   **GitHub:** [@Ugochi56](https://github.com/Ugochi56)
